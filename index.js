...
class Car {
  ...
  drive(distance){
    if((this.tank-(distance/this.milesPerGallon)<=0 )){this.odometer=this.odometer+(this.tank*this.milesPerGallon);this.tank=0;return `I ran out of fuel at ${this.odometer} miles!`}
...
class Instructor extends Lambdasian {
  constructor (iobj){
    super(iobj);
    this.specialty=iobj.specialty
    this.favLanguage=iobj.favLanguage
    this.catchPhrase=iobj.catchPhrase
  }
